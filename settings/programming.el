...
;; Some of the setup is taken from Daniel Higginbotham's clojure setup in
;; "Clojure for the Branve and True" book, see config file at [1].
;;
;; [1] https://github.com/flyingmachine/emacs-for-clojure/archive/book1.zip
...
;;
;; CIDER (Clojure interactice development environment that rocks)
;;
